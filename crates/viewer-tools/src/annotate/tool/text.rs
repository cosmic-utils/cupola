...
impl TextDragHandle {
    pub fn cursor(&self) -> cosmic::iced::mouse::Interaction {
        match self {
            Self::None => cosmic::iced::mouse::Interaction::Crosshair,
            Self::TopLeft | Self::BottomRight => {
                cosmic::iced::mouse::Interaction::ResizingDiagonallyDown
            }
            Self::TopRight | Self::BottomLeft => {
                cosmic::iced::mouse::Interaction::ResizingDiagonallyUp
            }
            Self::Top | Self::Bottom => cosmic::iced::mouse::Interaction::ResizingVertically,
            Self::Left | Self::Right => cosmic::iced::mouse::Interaction::ResizingHorizontally,
            Self::Move => cosmic::iced::mouse::Interaction::Grabbing,
        }
    }
}
